...
public class Trucos_concejos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trucos_concejos);
        ...
        buttonHomeTree.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Trucos_concejos.this, SecondActivity.class);
